...
// English (default)
export const courseData_en: DayData[] = [
  {
    id: 'intro',
    title: 'Introduction',
...
// German – full translations for Day 1, English fallback for others
export const courseData_de: DayData[] = [
  {
    id: 'intro',
    title: 'Einführung',
...
// Polish – full translations for Day 1, English fallback for others
export const courseData_pl: DayData[] = [
  {
    id: 'intro',
    title: 'Wprowadzenie',
...
export const courseDataByLanguage: Record<Language, DayData[]> = {
  en: courseData_en,
  de: courseData_de,
  pl: courseData_pl
};

export function getCourseData(lang: Language): DayData[] {
  return courseDataByLanguage[lang] || courseData_en;
}

// Backward compatibility: original export points to English
export const courseData: DayData[] = courseData_en;
