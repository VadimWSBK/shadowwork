...
<!-- Settings Modal -->
<div class="fixed inset-0 bg-primary/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
  <div class="bg-black/20 backdrop-blur-2xl border border-white/40 shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto" style="backdrop-filter: blur(24px); -webkit-backdrop-filter: blur(24px);">
    <!-- Header -->
    <div class="p-6 border-b border-white/20">
      <div class="flex items-center justify-between">
        <div class="flex items-center gap-3">
          <div class="w-12 h-12 bg-gradient-to-br from-white/20 to-white/10 backdrop-blur-xl flex items-center justify-center border border-white/30 shadow-lg">
        ...
        <button 
          ...
          class="p-2 text-white/60 hover:text-white/80 hover:bg-white/10 transition-all duration-200"
    ...
    <div class="p-6 space-y-4">
      ...
      {#if nameChangeSuccess}
        ...
        <div class="p-4 bg-green-500/20 border border-green-400/30 ">
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 bg-green-500/30  flex items-center justify-center">
      ...
      {:else if nameChangeError}
        ...
        <div class="space-y-4">
          <div class="p-4 bg-red-500/20 border border-red-400/30 ">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 bg-red-500/30  flex items-center justify-center">
          ...
          <div class="p-4 bg-white/10 border border-white/20">
            <h3 class="text-white font-medium mb-3">{t(currentLanguage, 'settings.changeName')}</h3>
            <div class="space-y-3">
              <input
                type="text"
                bind:value={newName}
                class="w-full px-3 py-2 bg-white/10 border border-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-[#0C6E78] focus:border-[#0C6E78] transition-all duration-200"
              />
              {#if nameError}
              ...
              <div class="flex gap-2">
                <button 
                  ...
                  class="px-4 py-2 bg-[#0C6E78] hover:bg-[#0A5A63] text-white transition-colors duration-200 text-sm font-medium"
                >
                  {t(currentLanguage, 'settings.save')}
                </button>
                <button 
                  on:click={resetNameForm}
                  class="px-4 py-2 bg-white/10 hover:bg-white/15 text-white transition-colors duration-200 text-sm"
                >
      ...
      {:else if !showChangeName}
        ...
        <button 
          ...
          class="w-full p-4 bg-white/10 hover:bg-white/15 border border-white/20 transition-all duration-200 text-left group"
        >
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 bg-white/20 flex items-center justify-center group-hover:bg-white/25 transition-colors duration-200">
      ...
      {:else if !showDeleteConfirm}
        <button 
          ...
          class="w-full p-4 bg-red-500/20 hover:bg-red-500/30 border border-red-400/30 transition-all duration-200 text-left group"
        >
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 bg-red-500/30  flex items-center justify-center group-hover:bg-red-500/40 transition-colors duration-200">
              <svg class="w-5 h-5 text-red-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-4 bg-red-500/20 border border-red-400/30">
          ...
          <div class="flex gap-2">
            <button 
              ...
              class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white transition-colors duration-200 text-sm font-medium"
            >
      ...
      {:else if !showDeleteProfileConfirm}
        <button 
          ...
          class="w-full p-4 bg-red-600/20 hover:bg-red-600/30 border border-red-500/30 transition-all duration-200 text-left group"
        >
          <div class="flex items-center gap-3">
            <div class="w-10 h-10 bg-red-600/30  flex items-center justify-center group-hover:bg-red-600/40 transition-colors duration-200">
              <svg class="w-5 h-5 text-red-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16"></path>
              </svg>
            </div>
      ...
      {:else}
        <div class="p-4 bg-red-600/20 border border-red-500/30">
          <div class="flex items-center gap-3 mb-3">
            <div class="w-10 h-10 bg-red-600/30 flex items-center justify-center">
              <svg class="w-5 h-5 text-red-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z"></path>
              </svg>
            </div>
          ...
          <div class="flex gap-2">
            <button 
              ...
              class="px-4 py-2 bg-red-700 hover:bg-red-800 disabled:bg-red-900 disabled:opacity-50 text-white transition-colors duration-200 text-sm font-medium flex items-center gap-2"
            >
              {#if deleteProfileSuccess}
            ...
            <button 
              ...
              class="px-4 py-2 bg-primary/10 hover:bg-primary/15 disabled:bg-primary/5 disabled:opacity-50 text-white transition-colors duration-200 text-sm"
            >
              {t(currentLanguage, 'settings.cancel')}
            </button>
          </div>
